...
define void @proc_main() {
  %a93754 = call i64 @prim_set()                                                     ; call prim_set
  %arg93756 = call i64 @const_init_int(i64 1)                                        ; quoted int
  %retprim93755 = call i64 @prim_set_45add(i64 %a93754, i64 %arg93756)               ; call prim_set_45add
  %cloptr93768 = call i64* @alloc(i64 8)                                             ; malloc
  %eptr93769 = getelementptr inbounds i64, i64* %cloptr93768, i64 0                  ; &cloptr93768[0]
  %f93770 = ptrtoint void(i64,i64,i64)* @lam93765 to i64                             ; fptr cast; i64(...)* -> i64
  store i64 %f93770, i64* %eptr93769                                                 ; store fptr
  %arg93760 = ptrtoint i64* %cloptr93768 to i64                                      ; closure cast; i64* -> i64
  %arg93759 = add i64 0, 0                                                           ; quoted ()
  %cloptr93771 = inttoptr i64 %arg93760 to i64*                                      ; closure/env cast; i64 -> i64*
  call i64 @expect_closure(i64* %cloptr93771)                                        ; assert function application
  %i0ptr93772 = getelementptr inbounds i64, i64* %cloptr93771, i64 0                 ; &cloptr93771[0]
  %f93774 = load i64, i64* %i0ptr93772, align 8                                      ; load; *i0ptr93772
  %fptr93773 = inttoptr i64 %f93774 to void (i64,i64,i64)*                           ; cast fptr; i64 -> void(...)*
  musttail call fastcc void %fptr93773(i64 %arg93760, i64 %arg93759, i64 %retprim93755); tail call
  ret void
}
...
define void @lam93765(i64 %env93766, i64 %_950, i64 %x) {
  %_951 = call i64 @prim_halt(i64 %x)                                                ; call prim_halt
  %cloptr93775 = inttoptr i64 %_951 to i64*                                          ; closure/env cast; i64 -> i64*
  call i64 @expect_closure(i64* %cloptr93775)                                        ; assert function application
  %i0ptr93776 = getelementptr inbounds i64, i64* %cloptr93775, i64 0                 ; &cloptr93775[0]
  %f93778 = load i64, i64* %i0ptr93776, align 8                                      ; load; *i0ptr93776
  %fptr93777 = inttoptr i64 %f93778 to void (i64,i64)*                               ; cast fptr; i64 -> void(...)*
  musttail call fastcc void %fptr93777(i64 %_951, i64 %_951)                         ; tail call
  ret void
}
